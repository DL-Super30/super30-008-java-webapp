...
export default function Editopportunity(props) {
    const {setShowEditOpportunity} = props;
    return (
        <div className="w-full h-[100vh] border-2 absolute top-0 bg-black bg-opacity-50 py-4"  >
            ...
            <div className="w-[60%] h-[95vh] rounded-lg border-2 mx-auto bg-white p-3 ">
                <div className="flex justify-between ">
                    ...
                    <button><FontAwesomeIcon icon={faXmark} className="mx-auto text-gray-300 p-2 text-2xl" onClick={() => setShowEditOpportunity(false)} /></button>
                </div>
                ...
                <div className=" flex mt-5">
                        ...
                        <button className="ml-[33%] w-[15%] p-2 border border-blue-500 rounded-lg text-center text-blue-500" onClick={()=>setShowEditOpportunity(false)}>Cancel</button>

...
import { faAddressCard, faAngleDown, faXmark, faAnglesLeft, faAnglesRight, faChevronLeft, faChevronRight, faSquarePollVertical, faTable, faEdit, faTrash } from '@fortawesome/free-solid-svg-icons'
...
export default function Opportunities() {
    ...
    const [selectOpportunity, setSelectOpportunity] = useState(null)
    ...
    const fetchdata = async () => {
        try {
            const response = await fetch(`${Api_Url}/opportunitydata`, { method: 'GET' })
    ...
    const deleteOpportunity = async (opportunityid) => {
        try {
            await fetch(`${Api_Url}/opportunitydata/${opportunityid}`, { method: 'DELETE' })
            await fetchdata()
    ...
    const updatingOppurtunity = (oppData) => {
        setShowEditOpportunity(true)
        setSelectOpportunity(oppData)
    }
    ...
    return (
        <div className="bg-gradient-to-br from-purple-600 to-blue-500 min-h-screen p-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="flex items-center mb-4 md:mb-0">
                            ...
                            <select className="bg-white border-2 border-purple-300 rounded-lg py-2 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                                ...
                                <option>This Month Opportunities</option>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button
                                ...
                                onClick={() => setCreateOpportunity(true)}
                            >
                                Create Opportunity
            ...
            {ShowEditOpportunity && (
                <Editopportunity
                    setShowEditOpportunity={setShowEditOpportunity}
            ...
            {deletePopUp && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-8 max-w-sm w-full">
                        ...
                        <p className="mb-6">Are you sure you want to delete this opportunity?</p>
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                ...
                                onClick={() => deleteOpportunity(selectopportunityid)}
                            >
                                Delete
                            </button>
                        </div>

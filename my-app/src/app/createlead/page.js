        ...
        <div className="w-full h-auto border-2 absolute top-0  left-0 bg-black bg-opacity-50 py-14">
            <div className="w-[60%] h-[84vh] rounded-lg border-2 mx-auto p-3 bg-white">
                ...
                <div className=" flex mt-1">
                        ...
                        <button className="ml-[33%] w-[15%] p-2 border border-blue-500 rounded-lg text-center text-blue-500" onClick={() => setCreateLead(false)}>Cancel</button>
                    
                    
                        <button className="ml-[20px] w-[15%] p-2 border border-blue-500 bg-blue-500 rounded-lg text-center text-white">Create</button>

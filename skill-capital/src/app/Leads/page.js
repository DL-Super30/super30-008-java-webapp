...
import LeadForm from "../../components/leadform"; // Import your LeadForm component here
          ...
          <div className="flex justify-between items-center px-5 py-2">
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <div className="inline-flex rounded-md shadow-sm">
                <button
                  type="button"
                  className={`inline-flex gap-2 items-center px-4 py-1 text-sm font-normal border focus:border-transparent transition duration-700 rounded-s-lg ${
                    activeLeadStatus === "Not Contacted"
                ...
                <button
                  type="button"
                  className={`inline-flex gap-2 items-center px-4 py-1 text-sm font-normal border focus:border-transparent transition duration-700 ${
                    activeLeadStatus === "Attempted"
                      ? "bg-[#0176D3] text-white border-[#0176D3]"
                      : "bg-white text-black border-[#747474]"
                  }`}
              ...
              <div className="inline-flex rounded-md shadow-sm">
                <button
                  className={`flex items-center gap-2 px-4 py-2 text-sm font-normal border rounded-s-lg ${
                    activeView === "Table" ? "bg-[#0176D3] text-white" : "bg-white text-black border-[#747474]"
                  }`}
                ...
                <button
                  className={`flex items-center gap-2 px-4 py-2 text-sm font-normal border rounded-e-lg ${
                    activeView === "Kanban" ? "bg-[#0176D3] text-white" : "bg-white text-black border-[#747474]"
                  }`}

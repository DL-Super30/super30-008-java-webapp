      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-4xl h-[100vh] flex flex-col">
        ...
        <div className="overflow-y-auto flex-1 p-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              <label className="font-medium text-base">Id Proof</label>
              <input
                type="text"
                name="Idproof"
                value={formData.name}
            ...
            <div className="flex flex-col">
              <label className="font-medium text-base">Date of Birth</label>
              <input
                type="date"
                name="DateofBirth"
            ...
            <div className="flex flex-col">
              <label className="font-medium text-base">Registered Date</label>
              <input
                type="date"
            ...
            <div className="flex flex-col">
              <label className="font-medium text-base">Batch ID's</label>
              <input
                type="text"
                name="BatchID"
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="w-full p-2 border rounded"
              >
                <option value="Not Contacted">select Location</option>
                <option value="None">None</option>
                <option value="Advanced Discussion">Advanced Discussion</option>
                <option value="Ready to Join">Ready to Join</option>
                <option value="Visiting">Visiting</option>
                <option value="Visiting">Fees Negotiation</option>
                <option value="Visiting">Batch Allocation</option>
                <option value="Visiting">Intrested in Demo</option>
                <option value="Visiting">Need Time This Week</option>
                <option value="Visiting">Need Time Next Week</option>
                <option value="Visiting">Need Time This Month</option>
                <option value="Visiting">Need Time Next Week</option>
                <option value="Visiting">Special Requirements</option>
                <option value="Visiting">Payment Link Sent</option>
                <option value="Visiting">Closed Won(Registered)</option>
                <option value="Visiting">Busy and Asked a Call back</option>
                <option value="Visiting">Closed Lost</option>
              </select>
            </div>
            <div className="flex flex-col">
              <label className="font-medium text-base">Alternative phone</label>
              <input
                type="text"
              ...
              <div className="flex flex-col">
              <label className="font-medium text-base">Exchange Rate</label>
              <input
                type="text"
                name="Exchange Rate"
              ...
              <div className="flex flex-col">
              <label className="font-medium text-base">Attended Demo</label>
              <select
                name="Attended Demo"
                ...
                className="w-full p-2 border rounded"
              >
                <option value="Not Contacted">select Attended Demo</option>
                <option value="None">None</option>
                <option value="Advanced Discussion">Advanced Discussion</option>
                <option value="Ready to Join">Ready to Join</option>
                <option value="Visiting">Visiting</option>
            ...
            <div className="flex flex-col">
              <label className="font-medium text-base">Learner Stage</label>
              <select
                name="Learner Stage"
            ...
            <div className="flex flex-col">
              <label className="font-medium text-base">Lead Created and Time</label>
              <input
                type="datetime-local"
                name="Lead Created and Time"

      ...
      <section>
        <div className="home w-full h-[88vh]">
          <div className="caption w-4/5 h-full mx-auto">
            ...
            <h1 className="text-5xl md:text-8xl text-center font-bold pt-5">Get <span className="text-green-500">Skilled</span> to <span >Reach</span> <br /> Your <span>Goal</span></h1>
